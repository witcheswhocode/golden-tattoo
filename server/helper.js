...
export function findMaxLetterUsage(letterCounts, words) {
...
export function findMaxLetterUsageAscending(letterCounts, words) {
  // Function to count letters in a word
  function countLetters(word) {
    let counts = {};
    for (let letter of word) {
...
export function findMaxLetterUsageWithStartingWord(letterCounts, words) {
  function countLetters(word) {
    let counts = {};
    for (let letter of word) {
      if (letter.match(/[a-zA-Z]/)) {
...
export const getNumOfLettersTotal = (bracelets) => {
  let count = 0;
...
export function getOptimizedLists(letterCounts, wordList) {
